...
Draft is written to newsletter_drafts/ in the repo; send it manually via Gmail
(paste into a new email to your subscriber list) or whatever newsletter tool you
already use.
...
def main():
    ...
    print("Review and send manually via Gmail or your newsletter tool of choice.")
