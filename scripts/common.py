...
def send_email_gmail(to_email: str, to_name: str, subject: str, body_text: str,
                      sender_name: str = "Bizlance"):
    """Sends an email via Gmail SMTP. Free (500/day limit), no external email
    service needed — just a Gmail account and an App Password (NOT your regular
    Gmail password; generate one at myaccount.google.com/apppasswords).
    Required env: GMAIL_ADDRESS, GMAIL_APP_PASSWORD."""
    import smtplib
    import ssl
